...
for train_index, test_index in skf.split(FC_Orig_features_, y):
    ...
    # roc curve for models
    fpr1, tpr1, thresh1 = roc_curve(y_test1, y_pred8, pos_label=1)
    ...
    auc_score1 = roc_auc_score(y_test1, y_pred8)
  ...
  # plot roc curves
    plt.plot(tpr1, fpr1, linestyle='--',color='orange', label='CNN-LR')
...
for train_index, test_index in skf.split(FC_Orig_features_, y):
    ...
    sns.set(font_scale=2.5,style="white")
  # plot roc curves
    plt.plot(tpr1, fpr1, linestyle='--',color='orange', label='CNN-RF')
